...
export default function ChatPage({ params }: IPageProps) {
    ...
    return (
        <div className="xl:w-[60%] md:w-[70%] w-[90%] m-auto h-screen relative flex justify-center scrollbar-hidden">
            {
                !isLoading ?
                    (<div className="h-[calc(84%-3.5rem)] md:h-[calc(89%-3.5rem)] mt-14 pt-5 pb-2 flex flex-col items-start w-full gap-1 overflow-y-auto overflow-x-hidden scrollbar-hidden" ref={containerRef}>
                        {
                            messages.length > 0 ?
