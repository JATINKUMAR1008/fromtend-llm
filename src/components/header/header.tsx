...
export default function Header({ chatId }: HeaderProps) {
    ...
    return (
        <div className="w-full fixed z-10 h-14 flex py-4 items-center justify-around border-b-[1px] border-neutral-700 bg-[#202026]">
               ...
               {currentChat &&  <div className="flex gap-2">
